//C49677T JOB (ACCTNO,ROOM),'JAVA8 DM,51',CLASS=A,MSGLEVEL=(1,1),         
...
$WDIR/managesdk.sh -enableProfileAll -enableServers -sdkname $JVM;        
echo "set SDK for Node"$CNR"1:";                                          
echo "------------------------";                                          
WDIR=$WROOT"/wx"$CID"domain/wx"$CID$CNR"1node/as/profiles/default/bin";   
$WDIR/managesdk.sh -setNewProfileDefault -sdkname $JVM  ;                 
$WDIR/managesdk.sh -setCommandDefault -sdkname $JVM  ;                    
$WDIR/managesdk.sh -enableProfile -sdkname $JVM -profileName default -user xxxxx -password xxxx ;  
/*                                                                        
